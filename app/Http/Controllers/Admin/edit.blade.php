...
<div class="bg-white p-8 rounded-lg shadow">
    ...
    <form action="{{ route('admin.skills.update', $skill) }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="text" name="name" id="name" class="w-full border rounded px-3 py-2" value="{{ $skill->name }}" required>
        </div>

        <div class="mb-4">
            <label for="type" class="block text-gray-700">Type</label>
            <select name="type" id="type" class="w-full border rounded px-3 py-2" required>
                <option value="development" @if($skill->type == 'development') selected @endif>Development</option>
                <option value="design_tool" @if($skill->type == 'design_tool') selected @endif>Design & Tool</option>
            </select>
        </div>

        <div class="mb-4">
            <label for="icon" class="block text-gray-700">Icon Name</label>
            <input type="text" name="icon" id="icon" class="w-full border rounded px-3 py-2" value="{{ $skill->icon }}" placeholder="e.g., html" required>
        ...
        <div class="mb-4">
            ...
            <input type="text" name="color_class" id="color_class" class="w-full border rounded px-3 py-2" value="{{ $skill->color_class }}" placeholder="e.g., bg-red-500">
